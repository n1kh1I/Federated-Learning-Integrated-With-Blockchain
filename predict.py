...
web3 = Web3(HTTPProvider('https://fragrant-cosmological-silenc.discover.quiknode.pro/8300eccc3e0a36219f3160b86c7c03/'))
...
trained_model = federated_learning(dataset_partitions, num_comm_rounds, num_selected_participants)
...
# Reading the binary data of the model file
...
private_key = 'df2ad361f8cb79f77076a3a757219eb8b029fa7f3e6b'
